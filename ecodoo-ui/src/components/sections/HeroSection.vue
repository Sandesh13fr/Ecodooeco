...
<template>
  <section id="top" class="relative min-h-svh overflow-hidden bg-[#0a1628] text-white">
    ...
    <!-- ─── Hero Content ─── -->
    <PageContainer class="relative flex min-h-svh flex-col justify-end pb-16 pt-36 sm:pb-20 lg:pb-24">
      <div class="max-w-5xl">
        <!-- Pill Badge -->
        ...
        <!-- Main Headline -->
        <h1 class="animate-fade-up-delay-1 text-5xl font-extrabold leading-[1.02] sm:text-7xl lg:text-8xl">
          <span class="block text-white">Every operation</span>
          <span class="block gradient-text mt-1">becomes ESG evidence.</span>
        </h1>

        <!-- Subtext -->
        <p class="animate-fade-up-delay-2 mt-6 max-w-[58ch] text-base leading-7 text-white/70 sm:text-lg sm:leading-8">
        ...
        <div class="animate-fade-up-delay-3 mt-10 flex flex-wrap items-center gap-4">
          ...
          >
            Explore the demo
            <svg class="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" viewBox="0 0 16 16" fill="none">
        ...
        <!-- Trust Indicators -->
        <div class="animate-fade-up-delay-3 mt-12 flex flex-wrap items-center gap-6 text-xs text-white/50">
          ...
          <span class="flex items-center gap-2">
            <svg class="h-4 w-4 text-teal" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <div class="absolute bottom-8 right-8 hidden lg:flex scroll-indicator">
        <span class="text-xs font-medium tracking-widest text-white/30 uppercase" style="writing-mode: vertical-rl">Scroll</span>
